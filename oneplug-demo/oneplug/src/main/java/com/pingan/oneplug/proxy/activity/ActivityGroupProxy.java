...
public class ActivityGroupProxy extends ActivityGroup implements ActivityGroupProxyAdapter {

    private MAActivityGroup target;
    ...
    public void loadTargetActivity() {
        if (target == null && !super.isFinishing()) {
            ...
            try {
                target = ((MAActivityGroup) ProxyEnvironment.getInstance(targetPackageName).getDexClassLoader()
                        .loadClass(targetClassName).asSubclass(MAActivityGroup.class).newInstance());
