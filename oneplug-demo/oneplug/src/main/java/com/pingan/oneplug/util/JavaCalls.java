...
public class JavaCalls {
    ...
    public static Object invokeMethodThrowException(Object object, String methodName, Class<?>[] parameterTypes, Object[] parameters) 
            throws MethodReflectException {
        Method method = getDeclaredMethod(object, methodName, parameterTypes);
        try {
            if (null != method) {
                method.setAccessible(true);
            ...
            e.printStackTrace();
            throw new MethodReflectException("IllegalArgumentException " + e.getMessage());
        } catch (IllegalAccessException e) {
            e.printStackTrace();
            throw new MethodReflectException("IllegalAccessException " + e.getMessage());
        } catch (InvocationTargetException e) {
            e.printStackTrace();
            throw new MethodReflectException("InvocationTargetException " + e.getMessage());
        }
        return null;
    }
